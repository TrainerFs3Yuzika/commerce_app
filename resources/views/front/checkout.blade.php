                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <textarea name="address" id="address" cols="30" rows="3"
                                                placeholder="Alamat Cth:Nama Jalan,Gedung, No.Rumah" class="form-control" class="form-control">{{ !empty($customerAddress) ? $customerAddress->address : '' }}</textarea>
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                        ...
                        <div class="card cart-summery">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between summery-end">
                                    ...
                                    <div class="h6"><strong>Rp{{ number_format($subTotal, 0, '', '.') }}</strong>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between summery-end">
