        ...
        <form id="orderForm" name="orderForm">
            <div class="row">
                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body checkout-form">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <input type="text" name="apartment" id="apartment" class="form-control" placeholder="Kecamatan (opsional)" value="{{ !empty($customerAddress) ? $customerAddress->apartment : '' }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <input type="text" name="state" id="state" class="form-control" placeholder="Provinsi" value="{{ !empty($customerAddress) ? $customerAddress->state : '' }}">
                                        <p></p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <input type="text" name="mobile" id="mobile" class="form-control" placeholder="Nomor Telepon" value="{{ !empty($customerAddress) ? $customerAddress->mobile : '' }}">
                                        <p></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <textarea name="order_notes" id="order_notes" cols="30" rows="2" placeholder="Catatan Pemesanan (opsional)" class="form-control"></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="card cart-summery">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between summery-end">
                                ...
                                {{-- <div class="h6"><strong>Rp{{ Cart::subtotal() }}</strong>
                            </div> --}}
                ...
                <div id="discount-response-wrapper">
                    @if (Session::has('code'))
                    <div class="mt-4 d-flex justify-content-center align-items-center" id="discount-response" style="background-color: #06D001; width: 300px; height: 50px; position: relative;">
