                            ...
                            <div class="col-md-12">
                                <table class="table table-striped">
                                    ...
                                    <tr>  
                                        ...
                                        <td>{{ ($shippingCharge->country_id == 'semua_negara') ? 'Semua Negara' : $shippingCharge->name }}</td>
                                        <td>Rp{{ $shippingCharge->amount }}</td>
                                        <td>
                                            <a href="{{ route('shipping.edit', $shippingCharge->id) }}" class="btn btn-primary">Edit</a>
                                            <a href="javascirpt:void(0)" onClick="deleteRecord({{$shippingCharge->id}})" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
